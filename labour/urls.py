from .views import LabourViewSet, SkillBasedLabourListViewSet , LocationSkillBasedJobListViewSet, JobViewSet, SkillBasedJobListViewSet
...
urlpatterns = [
    ...
    path('jobs/<skill>/', SkillBasedJobListViewSet.as_view()),
